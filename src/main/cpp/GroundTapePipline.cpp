...
GroundTapePipline::GroundTapePipline() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void GroundTapePipline::Process(cv::Mat& source0){
	//Step HSL_Threshold0:
	//input
	cv::Mat hslThresholdInput = source0;
	double hslThresholdHue[] = {27.51798561151078, 131.5151515151515};
 ...
 */
cv::Mat* GroundTapePipline::GetHslThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GroundTapePipline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GroundTapePipline::GetFilterContoursOutput(){
	...
	void GroundTapePipline::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void GroundTapePipline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
